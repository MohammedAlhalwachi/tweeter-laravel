<template>
    <div @click="" class="overflow-hidden p-4 pb-1 mb-3 bg-white shadow transition duration-150 ease-in-out cursor-pointer sm:p-6 sm:pb-2 hover:bg-gray-50 sm:mb-0 last:sm:border-b-0 sm:border-b-2 sm:border-gray-200 sm:last:rounded-b-md sm:first:rounded-t-md">
        ...
        <div class="flex justify-around items-center pl-14 mt-1 text-sm text-gray-400">
            <button @click.stop="" class="flex flex-1 justify-center items-center py-2 rounded-md transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none hover:text-green-500">
            ...
            <button @click.stop="" class="flex flex-1 justify-center items-center py-2 rounded-md transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none hover:text-yellow-500">
...
<script>
    ...
    export default {
        ...
        props: ['id', 'body', 'user', 'images', 'likes_count', 'is_liked', 'created_at'],
        data() {
            return {
                retweets: 65,
                likes: 0,
